export const config = {
	...
	role: 0,
	author: ['Sky'],
	viDesc: "Tính thời gian thức dậy hoàn hảo cho bạn",
        enDesc: "Calculate the perfect time to wake up for you",
...
export function onMessage({ api, event, args, getText }) {
	...
	if (isNaN(contentHour) || isNaN(contentMinute) || contentHour > 23 || contentMinute > 59 || contentHour < 0 || contentMinute < 0 || contentHour.length != 2 || contentMinute.length != 2)  return client.throwError(this.config.name);
